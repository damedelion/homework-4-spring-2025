...
class TestAudiences(BaseCase):
    ...
    def setup_teardown_audience(self, request):
        """Фикстура для создания/удаления аудитории только для тестов с маркером needs_audience"""
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_empty_state_ui_elements(self):
        audiences_page = self.feed_page.go_to_audiences_page()
        
        assert audiences_page.is_empty_state_ui_correct()

    def test_create_audience_button_click(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_kebab_menu_options_empty_state(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_navbar_ui_with_audiences(self):
        audiences_page = self.feed_page.go_to_audiences_page()

        assert audiences_page.is_navbar_ui_correct()

    @pytest.mark.needs_audience
    def test_audience_list_ui(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    @pytest.mark.needs_audience
    def test_share_button_tooltip_without_selection(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    @pytest.mark.needs_audience
    def test_delete_button_tooltip_without_selection(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_create_audience_menu_ui(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_audience_name_validation(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_add_source_button(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_exclude_source_button(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_source_edit_button(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_excluded_source_edit_button(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_same_source_and_excluded_source_error(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_successful_audience_creation(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_add_source_menu_ui(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_source_category_link(self):
        audiences_page = self.feed_page.go_to_audiences_page()
    ...
    def test_exclude_source_menu_ui(self):
        audiences_page = self.feed_page.go_to_audiences_page()
